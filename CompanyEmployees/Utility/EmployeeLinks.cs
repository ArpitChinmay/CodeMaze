...
namespace CompanyEmployees.Utility
{
    public class EmployeeLinks : IEmployeeLinks
    {
        ...
        private bool ShouldGenerateLinks(HttpContext httpContext)
        {
            ...
            return mediaType.SubTypeWithoutSuffix.EndsWith("hareoas", StringComparison.InvariantCultureIgnoreCase);
        }

        private LinkResponse ReturnShapedEmployees(List<Entity> shapedEmployees) => new LinkResponse { ShapedEntities = shapedEmployees };

        private LinkResponse ReturnLinkedEmployees(IEnumerable<EmployeeDto> employeeDto, string fields, Guid companyId, 
