...
namespace Service
{
    internal sealed class CompanyService :  ICompanyService
    {
        ...
        public async Task<IEnumerable<CompanyDto>> GetByIdsAsync(IEnumerable<Guid> companyIds, bool trackChanges)
        {
            ...
            {
                throw new CompanyIdsParameterIsNullBadRequestException();
            }
            ...
            { 
                throw new CollectionMismatchBadRequestException();
            }
        ...
        public async Task<(IEnumerable<CompanyDto> companies, string ids)> CreateCompanyCollectionAsync(IEnumerable<CompanyForCreationDto> companyCollection)
        {
            ...
            {
                throw new CompanyCollectionIsNullBadRequestException();
            }
